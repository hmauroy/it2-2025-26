...
DeleKnapp=tk.Button(Ramme, text="/", width=BreddeKnapp, height=HøydeKnapp, background="grey", foreground="red")
DeleKnapp.grid(row=2, column=3)
DeleKnapp.configure(
    command=lambda: les_DeleKnapp("resultat")
)
 
GangeKnapp=tk.Button(Ramme, text="*", width=BreddeKnapp, height=HøydeKnapp, background="grey", foreground="red")
GangeKnapp.grid(row=3, column=3)
GangeKnapp.configure(
    command=lambda: les_GangeKnapp("resultat")
)
 
MinusKnapp=tk.Button(Ramme, text="-", width=BreddeKnapp, height=HøydeKnapp, background="grey", foreground="red")
MinusKnapp.grid(row=4, column=3)
MinusKnapp.configure(
    command=lambda: les_MinusKnapp("resultat")
)
 
PlussKnapp=tk.Button(Ramme, text="+", width=BreddeKnapp, height=HøydeKnapp, background="grey", foreground="red")
PlussKnapp.grid(row=5, column=2)
PlussKnapp.configure(
    command=lambda: les_PlussKnapp("resultat")
)
 
Er_lik_Knapp=tk.Button(Ramme, text="=", width=BreddeKnapp, height=HøydeKnapp, background="grey", foreground="red")
...
tom=tk.Button(Ramme, text="Cloud\nNova", width=5, height=3, background="grey", foreground="black")
